class ZCL_Z_00_EXAMPLE_DPC definition
  public
...
protected section.
  ...
  methods PRODUCTSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_00_EXAMPLE_MPC=>TS_PRODUCT
    raising
  ...
  methods PRODUCTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_00_EXAMPLE_MPC=>TT_PRODUCT
...
CLASS ZCL_Z_00_EXAMPLE_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 10/01/2024 20:42:30 in client 110
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_00_EXAMPLE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA productset_create_entity TYPE zcl_z_00_example_mpc=>ts_product.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_get_entity TYPE zcl_z_00_example_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_00_EXAMPLE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA productset_get_entityset TYPE zcl_z_00_example_mpc=>tt_product.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_update_entity TYPE zcl_z_00_example_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
