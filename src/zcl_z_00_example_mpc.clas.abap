class ZCL_Z_00_EXAMPLE_MPC definition
  public
...
CLASS ZCL_Z_00_EXAMPLE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_00_EXAMPLE_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_00_EXAMPLE_MPC=>TS_PRODUCT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20241001204227'.                  "#EC NOTEXT
